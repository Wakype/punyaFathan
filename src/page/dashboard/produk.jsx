...
const products = [
  ...
  { id: 2, name: "Tacret enak bangat", price: "Rp. 15.000", image: "background.png" },
  { id: 1, name: "Nasi uduk ", price: "Rp. 20.000", image: "background.png" },
  { id: 2, name: "telor mie (DARMIE)", price: "Rp. 15.000", image: "background.png" },
  // Anda bisa menambahkan lebih banyak item dengan URL gambar yang sesuai
];
    ...
    <div className="dashboard flex h-[630px] w-screen bg-gray-200">
      ...
      <div className="bg-blue-900 text-white w-64 space-y-6 py-7 px-2">
        ...
        <nav>
            ...
            <Link to="/dashboard/Produk" className="block py-2.5 px-4 hover:bg-blue-600">Produk</Link>
            <Link to="/dashboard/Blog" className="block py-2.5 px-4 hover:bg-blue-600">Blog</Link>
          </nav>
      </div>
      ...
      <div className="flex-1 p-5 w-screen ">
        ...
        <input className="p-2 border rounded-md" placeholder="Search"/>
          ...
          <button className="bg-blue-500 text-white p-2 rounded-md">Profile</button>
            <button className="bg-blue-500 text-white p-2 rounded-md">Notifikasi</button>
            <button className="bg-blue-500 text-white p-2 rounded-md">Keranjang</button>
          
        </div>
        <h1 className="text-2xl font-bold m-5">PRODUK</h1>
        <div className="grid grid-cols-3 gap-4 p-5 space-x-0">
        
          {products.map(product => (
            <div key={product.id} className="bg-blue-500 p-4 rounded shadow-md w-80 h-80">
